...
import { inputStyle, labelStyle, sectionStack } from "./styles";
...
export default function PropertiesPanel() {
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#98a2b3", marginTop: 2, lineHeight: 1.5 }}>
                When checked, the host activity is cancelled when this event fires.
                Uncheck for non-interrupting (dashed ring).
              </div>
            </div>
          </label>
        </div>
  ...
  if (bpmnType === "lane") {
    sections.push({
      ...
      defaultOpen: true,
      content: (
        <div style={{ fontSize: 11, color: "#98a2b3", lineHeight: 1.55 }}>
        ...
        content: (
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#98a2b3", marginTop: 2, lineHeight: 1.5 }}>
                When checked, the first arriving event starts a new process instance
                (no incoming flow needed).
              </div>
            </div>
          </label>
        ),
